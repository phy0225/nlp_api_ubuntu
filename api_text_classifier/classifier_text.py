...
#读取文件
try:
    train_text = pd.read_csv(r'D:\dta\train.csv',encoding='utf-8')
except:
    train_text = pd.read_csv(r'D:dta\train.csv',encoding='gbk')

test_text = pd.read_csv(r'D:\dta\test1.csv',encoding='gb18030')
