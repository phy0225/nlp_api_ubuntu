...
from init_text_similar import init
...
if __name__ == '__main__':
    ...
    #        '蜘蛛痣（+），肝掌（＋）。巩膜黄染，腹膨隆，全腹无明显压痛、反跳痛、肌卫，' \
    #        '肝肋下未及，脾脏肿大平脐，肝肾区叩痛（－），麦氏征（-），莫氏征（-），' \
    #        '移动性浊音（+），肠鸣音不亢。四肢脊柱无红肿畸形，双下肢水肿。患者水肿较前加重，' \
    #        '增加利尿剂剂量为速尿40mg qdpo，安体舒通80mg qdpo。' \
